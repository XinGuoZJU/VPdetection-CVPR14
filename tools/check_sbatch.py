...
def run(dataset_name, idx, save_op):
    ...
    data_path = '/n/fs/vl/xg5/workspace/baseline/VPdetection_CVPR14/dataset/' \
                                                        + dataset_name + '/output'
    error_file = '/n/fs/vl/xg5/workspace/baseline/VPdetection_CVPR14/logs/' \
                                    + dataset_name + '_' + str(idx) + '_error.txt'
    error_file2 = '/n/fs/vl/xg5/workspace/baseline/VPdetection_CVPR14/error_logs/' + dataset_name + '.txt'
