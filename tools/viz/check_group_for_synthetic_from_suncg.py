...
if __name__ == '__main__':
    image_path = '/n/fs/vl/xg5/workspace/baseline/VPdetection-CVPR14/demo_data/imgs'
    org_path = '/n/fs/vl/xg5/workspace/baseline/VPdetection-CVPR14/tools/data/data.json'
    save_path = '/n/fs/vl/xg5/workspace/baseline/VPdetection-CVPR14/tools/viz_group'
